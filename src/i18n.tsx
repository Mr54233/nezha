...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "notif.soundToggle": "Notification Sound",
    "notif.soundToggleDesc": "Play a sound when a task notification appears",
    ...
    "notif.typeIdle": "Waiting for input",
    "notif.typeInputRequired": "Permission required",
    "notif.hooksConsent": "Allow Hook Injection",
    "notif.hooksConsentDesc": "Inject hooks into Claude Code settings to enable task notifications",
    "notif.hooksConsentToast": "Task notifications require injecting hooks into Claude Code. Authorize now?",
    ...
    "taskNotif.inputRequired": "Permission required",
  },
  zh: {
    ...
    "notif.soundToggle": "通知声音",
    "notif.soundToggleDesc": "任务通知出现时播放提示音",
    "notif.toastPosition": "Toast 位置",
    "notif.typeFilterLabel": "通知类型",
    "notif.typeDone": "任务完成",
    "notif.typeFailed": "任务失败",
    "notif.typeIdle": "等待输入",
    "notif.typeInputRequired": "需要授权",
    "notif.hooksConsent": "允许注入 Hooks",
    "notif.hooksConsentDesc": "向 Claude Code 配置注入 hooks 以启用任务通知",
    "notif.hooksConsentToast": "任务通知需要向 Claude Code 注入 hooks，是否授权？",
